...
% No baseline subtraction; Byron 9-3-2012
AUTOZERO = 0;
fprintf('peakfit: AUTOZERO set to 0; no baseline subtraction\n');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Count negative values generated by
...
if AUTOZERO ~= 0
    ...
    q = yy < 0;
    numNegatives = sum(q);
    fprintf('peakfit: %d negative values out of %d\n', numNegatives, dataSize);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
